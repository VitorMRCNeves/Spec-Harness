# Fase 1 — Setup do repositório (roda uma vez)
...
- **Existe:** leia o arquivo inteiro, guarde o conteúdo para as fases seguintes e **pule para a
  Fase 2**. Não repita as perguntas.
...
## 1.1 — Escaneie antes de perguntar
...
| **Unidade de entrega** | O que conta como "uma spec" ali: um endpoint? um caso de uso? uma tela? um DAG? Sem isso a Fase 7 fatia errado |
...
construir. Esta fase é sobre o repositório; a feature começa na Fase 2.

---

## 1.3 — Escreva o perfil
...
3. **Marque o que ficou incerto** com `⚠️ ABERTO:` e diga o que resolveria. A Fase 5 pode
